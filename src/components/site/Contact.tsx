        ...
        >
          {[
            ...
            <label key={f.l} className="block">
              <span className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground">{f.l}</span>
              <input
                type={f.t}
                required
                className="mt-2 w-full bg-transparent border-b border-border py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition"
              />
            </label>
          ))}
          <label className="block">
            ...
            <textarea
              rows={3}
              className="mt-2 w-full bg-transparent border-b border-border py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition resize-none"
            />
          </label>
          <button
            type="submit"
            className="mt-4 w-full md:w-auto bg-primary text-primary-foreground px-8 py-4 text-sm uppercase tracking-[0.18em] hover:opacity-90 transition rounded-full"
          >
            Send Enquiry
          </button>
        </form>
