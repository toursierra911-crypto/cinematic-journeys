  ...
  return (
    <section id="top" className="relative h-screen min-h-[640px] w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full container-x flex flex-col justify-end pb-24 md:pb-32">
        <p className="fade-up text-xs md:text-sm uppercase tracking-[0.4em] text-white/80 mb-6">
          Curated Journeys · Est. 2014
        </p>
        <h1 className="fade-up font-display text-white font-semibold text-[clamp(2.75rem,8vw,7rem)] leading-[0.95] max-w-5xl">
          Travel Beyond <em className="not-italic font-light italic opacity-90">Limits</em>
        </h1>
        <p
          className="fade-up mt-8 max-w-xl text-white/85 text-base md:text-lg font-light"
        ...
        <div className="fade-up mt-10 flex items-center gap-6" style={{ animationDelay: "0.3s" }}>
          ...
          <a href="#experience" className="text-white/80 text-sm uppercase tracking-[0.18em] hover:text-white">
            Our Story
          </a>
        </div>
      </div>
